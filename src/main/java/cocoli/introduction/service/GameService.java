...
import cocoli.introduction.entity.response.Game;
import cocoli.introduction.entity.response.db.Item;
import cocoli.introduction.entity.response.db.ItemType;
...
public class GameService {
    private static final String TOKEN = "Bearer fhlj5dnfbad6d4gi54nu6auyjll286"; //my token
    private static final String CLIENT_ID = "rekds9517idve1drm26jkxrk4a7gff";  //my client ID
